...
"""Script to train RL agent with FastSAC."""
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: FastSacRunnerCfg):
    """Train with FastSAC agent."""
    # override configurations with non-hydra CLI arguments
    agent_cfg = cli_args.update_fast_sac_cfg(agent_cfg, args_cli)
    ...
    if args_cli.distributed:
        ...
        # Set agent device for single-GPU mode
    ...
    # create runner from FastSAC
    runner = FastSacRunner(env, agent_cfg.to_dict(), log_dir=log_dir, device=agent_cfg.device)
